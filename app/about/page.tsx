    ...
    <main>
            ...
            <div className="mx-auto flex h-full max-w-6xl items-end px-6 pb-10">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 text-base text-white/85">
                  We make quality, personal coaching accessible with a community
                  that keeps people improving.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <Button href="/sessions">View sessions</Button>
                  <Button href="/contact" variant="outline" className="border-white/30 text-white hover:bg-white/10 bg-white/20">
                    Enquire
                  </Button>
                </div>
              </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-ink/10 shadow-sm">
              <div className="relative aspect-[4/3]">
                <Image src="/photos/about/training-1.webp" alt="Pantheon training" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <Founder
              ...
              bio="George's journey began in London grassroots volleyball. Lacking a clear high-performance pathway, he built his own. Years of self-development have elevated him to the senior national squad, where he competes among the country's best. His work at Pantheon is driven by the belief that accessible, high-quality coaching can raise the standard of volleyball across London."
            />
            <Founder
              name="Chester Tang"
              role="Co-founder • Coach"
              image="/photos/founders/chester.webp"
              bio="Chester fell in love with volleyball at 18. He knows the joy of self-improvement, and is passionate about creating an inclusive and welcoming environment where players of all levels feel valued. He believes volleyball is a space where people improve, compete, and genuinely have fun. Chester brings a strong focus on individual learning to every session."
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface-alt">
        <div className="mx-auto max-w-6xl px-6 py-14">
          <div className="mt-10 rounded-3xl border border-ink/10 bg-ink-bg p-8">
            <h3 className="text-xl font-bold text-cream">Want to train with us?</h3>
...
function ImagePanel({ src, alt, caption }: { src: string; alt: string; caption: string }) {
  return (
    <div className="overflow-hidden rounded-3xl border border-ink/10 bg-surface shadow-sm">
      <div className="relative aspect-[4/3]">
        <Image src={src} alt={alt} fill quality={70} sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" />
      </div>
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-ink/10 bg-surface shadow-sm">
      <div className="relative aspect-[3/4]">
        ...
        {/* These overlays are over a photo so hardcoded dark is correct */}
        <div className="absolute inset-x-0 bottom-0 h-[32%]" style={{ backgroundColor: 'rgba(11, 46, 51, 0.9)' }} />
        <div className="absolute inset-x-0 bottom-[32%] h-28 bg-gradient-to-t from-[#0B2E33]/90 to-transparent" />
        ...
        <div className="absolute inset-x-0 bottom-0 p-6">
          <div className="max-w-[46ch]">
            ...
            <p className="mt-3 text-[15px] leading-relaxed tracking-[0.01em] text-white/90">{bio}</p>
          </div>
        </div>
      </div>
    </div>
...
function GalleryTile({ src, alt, className }: { src: string; alt: string; className?: string }) {
  return (
    <div className={`relative overflow-hidden rounded-3xl border border-ink/10 bg-surface shadow-sm ${className ?? ""}`}>
      <div className="relative h-full min-h-[220px]">
        <Image src={src} alt={alt} fill quality={70} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" className="object-cover" />
      </div>
    </div>
  );
}